...
def generate_report():
    ...
    try:
        ...
        if not graph_id:
            return (
                jsonify({"success": False, "error": t("api.missingGraphIdEnsure")}),
                400,
            )
        ...
        if not simulation_requirement:
            return (
                jsonify({"success": False, "error": t("api.missingSimRequirement")}),
                400,
            )
...
def search_graph_tool():
    ...
    try:
        ...
        if not graph_id or not query:
            return (
                jsonify({"success": False, "error": t("api.requireGraphIdAndQuery")}),
                400,
            )
